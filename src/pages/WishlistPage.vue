...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Warder Wishlist Page' },
    { name: 'keywords', content: 'marketplace, wishlist' },
  ],
})

const selectedSorted = ref()
const sort = ref([
  { name: 'Terbaru Disimpan', code: 'ASC' },
  { name: 'Terlama Disimpan', code: 'DESC' },
])
</script>
...
<template>
  <div class="flex-grow kontener mx-auto pt-[75px]">
    ...
    >
      <div class="w-full">
        <span class="hidden md:inline-block font-bold text-3xl"
          >Semua Wishlist |</span
        >
        20 Barang
      </div>
      <div
        class="inline-block xs:flex items-center space-x-0 xs:space-x-2 justify-between md:justify-end w-full"
      >
        <div class="text-end mb-1 xs:mb-0">Urutkan</div>
        <Select
    ...
    >
      ...
      >
        <div
          class="relative w-[250px] xxs:w-[175px] xs:w-[205px] h-[400px] xl:w-[230px] group border-2 rounded-lg flex-shrink-0 overflow-hidden cursor-pointer"
        >
